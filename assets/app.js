...
function initProduct() {
  ...
  root.innerHTML = `
    <div class="detail-visual"><span class="product-badge">${p.brand} · ${p.cat}</span></div>
    <div class="detail">
